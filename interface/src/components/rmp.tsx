// extremely temporary, until PR gets merged
// https://github.com/N3XT191/react-multi-progress/pull/4
...
export default function MultiProgress<T = Record<string, never>>({
  ...
  return (
    <div {...styles.progressContainer(round, height, border)} className={className}>
