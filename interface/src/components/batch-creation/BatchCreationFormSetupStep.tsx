...
function BatchCreationFormSetupStep() {
  return (
    <>
      <h2>Setup</h2>
...
BatchCreationFormSetupStep.validate = () => ({});

const toExport = BatchCreationFormSetupStep as BatchCreationStep;
