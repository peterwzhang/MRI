...
function BatchCreationFormSlurmStep(props: {
...
BatchCreationFormSlurmStep.validate = () => ({});

const toExport = BatchCreationFormSlurmStep as BatchCreationStep;
